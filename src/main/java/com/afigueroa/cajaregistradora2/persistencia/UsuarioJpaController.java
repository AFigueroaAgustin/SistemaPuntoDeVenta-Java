...
public class UsuarioJpaController implements Serializable {
    ...
    public Usuario findUsuarioPorNombre(String nombreRecibido) {
        EntityManager em = getEntityManager();
        try {

            String query = "SELECT u FROM Usuario u WHERE u.nombreUsuario = :abc";

            javax.persistence.TypedQuery<Usuario> q = em.createQuery(query, Usuario.class);

            q.setParameter("abc", nombreRecibido);
